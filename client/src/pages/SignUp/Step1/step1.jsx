      ...
      <p className='step-para'>Let's get started... Please provide the followig information</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            {errors.fullName && <span className="step1-error">{errors.fullName.message}</span>}
          </div>
          <div>
            ...
            {errors.email && <span className="step1-error">{errors.email.message}</span>}
          </div>
          <div>
            <label className="step-label">Password</label>
            <input className="step-input" type="password" {...register('password')} />
            {errors.password && <span className="step1-error">{errors.password.message}</span>}
          </div>
          <div>
            <label className="step-label">Repeat Password</label>
            <input className="step-input" type="password" {...register('repeatPassword')} />
            {errors.repeatPassword && <span className="step1-error">{errors.repeatPassword.message}</span>}
          </div>
